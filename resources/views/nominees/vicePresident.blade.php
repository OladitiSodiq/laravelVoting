...
<!-- Mirrored from www.themashabrand.com/scripts/Voting/nominees/398673516259 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Dec 2019 10:56:40 GMT -->
...
<head>
    ...
    <!-- Include header.php. Contains header content. -->
		...
		<link rel="apple-touch-icon" sizes="60x60" href="_br/__b_Notice_/b__%20%20Array%20to%20string%20conversion%20in%20_b_/home/fluffsco/public_html/scripts/Voting/source/frontend/template/header.php_/b_%20on%20line%20_b_27_/b__br/apple-touch-icon-60x60">
      ...
      <nav class="navbar navbar-default">
       <div class="container">
	    <div class="navbar-header">
		 ...
		 <a class="navbar-brand" href="../index.html">Voting</a>
		</div><!-- /.navbar-header -->
		 ...
		 <ul class="nav navbar-nav">
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                	<li class="m_2"><a onclick="changelanguage(456316203361)" style="cursor: pointer;">English</a></li><li class="m_2"><a onclick="changelanguage(492663265157)" style="cursor: pointer;">Spanish</a></li>	
        		</ul>
              </li>
           </ul>  
	  ...
	  <div class="container">
	   <div class="row">
			<div class="section-title" style="padding-top: 20px;">
				<h1>Organization :- Democratic National Committee</h1>
			</div>
	   
		  <p>No Content Available.</p><p>No Content Available.</p>	        </div><!-- /.row -->
	    </div><!-- /.container -->
	</div>	 	 
...
<script>
  ...
  gtag('config', 'UA-79656468-5');
	...
	function vote(nomineeid,organizationid,positionid) {
		...
		$.ajax({
			type: "POST",
			url: "https://www.themashabrand.com/scripts/Voting/source/frontend/template/requests/vote.php",
